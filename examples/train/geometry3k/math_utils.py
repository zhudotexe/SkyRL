# Ported from slime math_utils for Geometry-3K reward grading.
# Original source: https://github.com/THUDM/slime/blob/main/slime/rollout/rm_hub/math_utils.py Commit hash 67a21a1bc2c05d7fe8e25a92da1849b65a01e86d
"""
...
def extract_answer(passage: str) -> str | None:
    """Extract a boxed answer from the passage, or return None."""
    if "\\boxed" in passage:
...
def grade_answer_from_boxed(solution_str: str, ground_truth: str) -> bool:
    ...
    Extracts the answer from \\boxed{} in the solution, then checks equivalence
    using both MATH-D normalization and sympy-based simplification.
    """
    if not ground_truth:
        return False
